#!/usr/bin/env python3
"""
Corrected multimodal test for individual models
"""
...
def test_qwen_multimodal():
    ...
    try:
        ...
        # Process inputs - Qwen expects images parameter
...
def test_phi4_multimodal():
    ...
    try:
        ...
        # For Phi-4 ONNX, try AutoModelForCausalLM with trust_remote_code
...
if __name__ == "__main__":
    logger.info("Starting corrected multimodal tests...")
    
    # Test Qwen first (it loaded successfully)
