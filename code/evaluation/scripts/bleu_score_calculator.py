#!/usr/bin/env python3
"""
BLEU Score Calculator: QWEN vs OpenAI Answers
...
def save_results(results: List[Dict], stats: Dict):
    ...
    if pd is not None:
        ...
        csv_path = RESULTS_DIR / "per_question_bleu.csv"
        df.to_csv(csv_path, index=False)
        print(f"  ✅ Saved detailed results to: {csv_path}")
    else:
        # Fallback: save as JSON
        json_path = RESULTS_DIR / "per_question_bleu.json"
...
def main():
    ...
    print("="*70)
    print("BLEU Score Calculator: QWEN vs OpenAI Answers")
    print("="*70)
